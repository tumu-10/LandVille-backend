...
<head>
    ...
    <!-- Title -->
    <title>LandVille | <?php echo e(session('title')); ?></title>
        ...
        <div class="page-main">
            ...
            <aside class="app-sidebar app-sidebar3">
                ...
                <ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('services.index')); ?>">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('blogs.index')); ?>">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('mainTitles.index')); ?>">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('collages.index')); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="side-menu__icon">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('bg_videos.index')); ?>">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('property_images.index')); ?>">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('service_img.index')); ?>">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('testimonials.index')); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="side-menu__icon">
                                <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"></path>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
                        Copyright © 2025 <a href="#"><?php echo e(config('app.name')); ?></a>. Designed by <a href="#">Sir JayP</a>
                        All rights reserved.
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Sam T\Desktop\buyrentnow-master - Copy\buyrentnow-master\resources\views/layouts/master.blade.php ENDPATH**/ ?>