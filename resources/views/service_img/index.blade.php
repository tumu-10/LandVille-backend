...
<div class="page-header">
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <a class="btn btn-success" href="{{ route('service_img.create') }}"> Add new image</a>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap" id="example1">
                        ...
                        <tbody>
                            @foreach($service_img as $opportunity)
                            <tr>
                                ...
                                <td>
                                        <form action="{{ route('service_img.destroy', $opportunity->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
